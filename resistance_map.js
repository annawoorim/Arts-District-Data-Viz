...
var data_set = {
	...
	"POV_CHG" : {
		...
		"label3" : "2000: ",
		"label4" : "2015: ",
		"caption1" : "% change in poverty rate",
		"caption2" : "from 2000-2015",
		"unit" : " %",
	},
	"HOU_CHG" : {
		"min" : -25,
		"max" : 339,
		"title" : "Households with section 8 voucher",
		"label1" : "Neighborhood: ",
		"label2" : "Change from 2000-2015: ",
		"label3" : "2000: ",
		"label4" : "2015: ",
...
function updateBuildingMap(censusTractsFile, streetsFile, buildingFile) {
	...
	census_tracts.selectAll(".tract")
		...
		.attr("class", "tract")
		.attr("fill", "#e4f1fe")
		.attr("fill", function(d,i){if (i == 2) {return "#013243";} else {return "#e4f1fe";}})
